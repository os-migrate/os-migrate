...
class TestFilesystem(unittest.TestCase):
    ...
    def test_write_or_replace_resource_new_file(self):
        ...
        with utils.tmp_dir_context() as tmp_dir:
            ...
            filesystem.write_or_replace_resource(file_path, minimal_resource)
            ...
            self.assertEqual(resource["params"]["description"], "minimal resource")
    ...
    def test_write_or_replace_resource_existing_file(self):
        with utils.tmp_dir_context() as tmp_dir:
            ...
            self.assertTrue(filesystem.write_or_replace_resource(file_path, minimal2))
            # repeated replacement should report no changes - return False
            self.assertFalse(filesystem.write_or_replace_resource(file_path, minimal2))
            ...
            self.assertEqual(resource0["params"]["description"], "minimal resource")
            ...
            self.assertEqual(resource1["params"]["description"], "minimal two")
