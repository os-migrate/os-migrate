...
class TestResource(unittest.TestCase):
    ...
    def test_update_migration_params(self):
        ...
        self.assertEqual(
            res.migration_params(), {"migparam1": "val1", "migparam2": "val2"}
        )
        res.update_migration_params({"migparam3": None, "migparam4": "val4"})
        self.assertEqual(
            res.migration_params(),
    ...
    def test_data_validation(self):
        ...
        self.assertFalse(res.is_data_valid())
        self.assertEqual(
            res.data_errors(), ["Missing _info.id.", "Missing params.param1."]
        )
    ...
    def test_dst_prerequisites_errors(self):
        ...
        self.assertEqual(
            res.dst_prerequisites_errors(None),
